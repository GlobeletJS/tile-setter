...
`;
  ...
  function init(userParams) {
    ...
    api.promise = loadStyle(params.style, params.mapboxToken)
      .then( styleDoc => setup$1(styleDoc, params, api) );

    return api;
  }

  function setup$1(styleDoc, params, api) {
  ...
  function main() {
    ...
    init({ context, style: "./klokantech-basic-style.json" })
      .promise.then(api => setup(api, canvas))
      .catch(console.log);
  }

  function setup(api, canvas) {
    api.getViewport(window.devicePixelRatio);
